...
const TopNav = () => {
  ...
  return (
    <div className="max-w-[1520] flex items-center justify-between p-4 mx-auto">
      <div className="flex items-center">
        <div onClick={() => setSideNav(!sideNav)} className="cursor-pointer">
          <AiOutlineMenu size={25} />
        </div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Yum<strong>Eats</strong>
        </h1>
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]">
          <p className="bg-orange-700 rounded-full p-2 text-white font-bold">
            Free
          </p>
      ...
      <button className="bg-orange-700 rounded-full text-white hidden md:flex items-center py-2">
